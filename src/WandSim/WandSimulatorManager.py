...
def startSimulator():
    ...
    #propagate_rays_through_system_plane_surface(Projector, windowsList, reflectivesurface, projectorsList, cameraList)
...
def propagate_rays_through_system_plane_surface(Projector, windowsList, reflectiveSurface, projectorList, cameraList):
